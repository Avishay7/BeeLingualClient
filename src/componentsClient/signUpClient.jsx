      ...
      <div className="row justify-content-center ">
        <div className="col-md-6">
          ...
          <div className="card-body">
            ...
            <div className='text-center'>
              <button type="button" class="btn btn-primary btn-lg btn-block w-75">Sign Up</button>
            </div>
            <div className='text-center opacity-50'>
              <p>--------or sign up with--------</p>
            </div>
            <div className='text-center'>
              <svg xmlns="http://www.w3.org/2000/svg" width="50" height="30" fill="currentColor" class="bi bi-google" viewBox="0 0 16 16">
